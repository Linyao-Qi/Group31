...
\- View applicant list, hire/cancel hire
...
2\. The data folder must be deployed under the bin folder of Tomcat (data contains job.csv, application.csv, user.csv, storing all business data)
