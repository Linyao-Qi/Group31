...
public class TAProfile implements Serializable {
    ...
    private String cvSummary;   // plain-text CV / self-introduction

    public TAProfile() {}

    public TAProfile(String taId, String name, String email, String skills, String cvSummary) {
        this.taId = taId;
        this.name = name;
        this.email = email;
        this.skills = skills;
    ...
    public void setCvSummary(String cvSummary) { this.cvSummary = cvSummary; }
